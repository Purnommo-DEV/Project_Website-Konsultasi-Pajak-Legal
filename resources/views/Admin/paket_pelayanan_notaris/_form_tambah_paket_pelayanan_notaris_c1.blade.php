<div class="modal fade text-left" id="modal-tambah-jenis-pelayanan-notaris-child-1" data-bs-backdrop="static"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="form-tambah-jenis-pelayanan-notaris-child-1" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            <input name="tarif" id="tambah_tarif_pb_child1" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" accept="image/png, image/jpeg, image/jpg" name="path"
                                id="tambah-pl-notaris-c1-path" class="form-control">
                            <div class="input-group has-validation">
                                <label style="margin-top: 0.1rem; font-size: 0.8rem; font-weight: 600; "class="text-danger
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary ml-1" id="button-tambah-pelayanan-notaris-child1">
                        <i id="icon-button-tambah-pelayanan-notaris-child1"></i>
                        <span id="text-tambah-pelayanan-notaris-child1" class="d-none d-sm-block">
                            Simpan</span>
                    </button>
                </div>
            </form>
...
@push('script')
    <script>
        $('#form-tambah-jenis-pelayanan-notaris-child-1').on('submit', function(e) {
            e.preventDefault();
            var $search = $("#icon-button-tambah-pelayanan-notaris-child1")
            $("#icon-button-tambah-pelayanan-notaris-child1").addClass("fa fa-spinner fa-spin")
            $("#text-tambah-pelayanan-notaris-child1").html('')
            $("#button-tambah-pelayanan-notaris-child1").prop('disabled', true);
            var data = new FormData(this);
            data.append('req_p_pel_notaris_id', p_notaris);
            data.append('key', 'value');
            $.ajax({
                url: "{{ route('admin.ProsesTambahDataPaketPelayananNotarisChild1') }}",
                method: 'POST',
                headers: {
                ...
                success: function(data) {
                    if (data.status_form_kosong == 1) {
                        ...
                        $("#text-tambah-pelayanan-notaris-child1").html(
                            '<span id="text-tambah-pelayanan-notaris-child1" class="d-none d-sm-block">Simpan</span>'
                        )
                        $("#button-tambah-pelayanan-notaris-child1").prop('disabled', false);
                    } else if (data.status_berhasil_tambah == 1) {
                        $("#modal-tambah-jenis-pelayanan-notaris-child-1").modal('hide');
                        $("#form-tambah-jenis-pelayanan-notaris-child-1").trigger('reset');
        ...
        $(document).ready(function(e) {
            $("#tambah-pl-notaris-c1-path").change(function() {
                let file = this.files[0];
                let reader = new FileReader();
                var ext = $('#tambah-pl-notaris-c1-path').val().split('.').pop().toLowerCase();
                if ($.inArray(ext, ['png', 'jpg', 'jpeg']) == -1) {
                    ...
                    $("#tambah-pl-notaris-c1-path").val(null);
                } else {
